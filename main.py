...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type',
                        choices=['MLP_MLP', 'TF_MLP', 'MLP_CNN', 'TF_CNN', 'MLP_GCN', 'OGN_GCN', 'TF_GCN', 'TF_GIN', 'TF_SAGE'],
                        type=str, default='TF_GCN', help='model type')
    parser.add_argument('--mesh_type', choices=['square_grid', 'square_mesh','curvilinear',  'face'], type=str, default='face',
                        help='model type')
    parser.add_argument('--hp', type=float, default=1e-2, help='Loss hyperparameter for laplacian')
    ...
    parser.add_argument('--readout', choices=['MLP', 'Linear', 'Avg', 'Max'], type=str, default='MLP', help='readout type')
    ...
    args.name = args.name + "_" + args.model_type + "_" + args.mesh_type #+ "_" + args.elec_type + "_pos_att_" + str(
       # args.pos_att_switch)
    print(args.name)
    cli_main(args)
